 ...
 */
public class Cabecera extends Base {
	private static final long serialVersionUID = 1L;
	static final Logger log = Logger.getLogger(Cabecera.class);
    public Cabecera() {
        super();
    ...
    protected void procesarPeticion(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			String XML = getXMLCabecera(datosConf);
    ...
    private String getXMLCabecera(HashMap<String,Object> datosConf)
	{
